...
GraphTile::GraphTile(const std::string& tile_dir, const GraphId& graphid, CustomTileDecoder customTileDecoder) : header_(nullptr) {
  ...
  // If we were given a custom tile decoder, try that first
